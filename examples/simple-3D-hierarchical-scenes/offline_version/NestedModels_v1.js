...
<pre>{@code
      ...
      Matrix    nested  Matrix  nested    Matrix   nested
        T    Positions    T     Positions   T      Positions
                      \            |             /
                        \          |           /
                          \        |         /
                            \      |       /
...
const sphere_p = new Position(sphere);
p1.addNestedPosition([sphere_p]);
p2.addNestedPosition([sphere_p]);
p3.addNestedPosition([sphere_p]);
...
for (var i = 0; i <= 72; i++) {
  ...
  sphere_p.matrix.mult(Matrix.rotateY(5));
